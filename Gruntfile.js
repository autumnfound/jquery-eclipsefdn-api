module.exports = function( grunt ) {
  ...
  grunt.initConfig( {
    ...
    concat: {
      ...
      igc: {
        src: [ "src/jquery.eclipsefdn-igc.js" ],
        dest: "dist/jquery.eclipsefdn-igc.js"
      },
    },

    // Lint definitions
    jshint: {
      files: [ "src/jquery.eclipsefdn-api.js", "src/jquery.eclipsefdn-igc.js", "test/**/*" ],
      options: {
        jshintrc: ".jshintrc"
      }
    },
    ...
    uglify: {
      ...
      igc: {
        src: [ "dist/jquery.eclipsefdn-igc.js" ],
        dest: "dist/jquery.eclipsefdn-igc.min.js"
      },
      options: {
        banner: "<%= meta.banner %>"
      }
